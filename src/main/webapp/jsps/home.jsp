...
<html>
    <head>
        <title>techpulse-java-app</title>
        <meta charset="UTF-8">
...
<body>
    ...
    <div class="w3-top">
        <div class="w3-bar w3-black w3-wide w3-padding w3-card">
            <a href="#home" class="w3-bar-item w3-button"><b>Tech</b> <span style="color: red;">Pulse</span></b></a>
    ...
    <header class="w3-display-container w3-content w3-wide" style="max-width:1500px;" id="home">
        ...
        <div class="w3-display-middle w3-margin-top w3-center">
            <h1 class="w3-xxlarge w3-text-white"><span class="w3-padding w3-red w3-opacity-min"><b>Tech</b></span> <span
                    class="w3-hide-small w3-text-light-grey">| Pulse</span></h1>
        </div>
    </header>
    ...
    <div class="w3-content w3-padding" style="max-width:1564px">
        ...
        <div class="w3-row-padding">
            <div class="w3-col l3 m6 w3-margin-bottom">
                <div class="w3-display-container">
                    ...
                    <img src="https://ms-solutions-edu-web-java.s3.us-east-1.amazonaws.com/home/mr+dramacydal.jpeg" alt="Vin" style="width:100%">
                </div>
            </div>
            <div class="w3-col l3 m6 w3-margin-bottom">
                <div class="w3-display-container">
                    <div class="w3-display-bottomleft w3-padding" style="background-color: rgba(0, 0, 0, 0.5); color: white;"><b>Engineer Allen</b></div>
                    <img src="https://ms-solutions-edu-web-java.s3.us-east-1.amazonaws.com/home/allen.JPEG" alt="Allen" style="width:100%">
                </div>
            </div>
            <div class="w3-col l3 m6 w3-margin-bottom">
                <div class="w3-display-container">
                    <div class="w3-display-bottomleft w3-padding" style="background-color: rgba(0, 0, 0, 0.5); color: white;"><b>Engineer Vanisa</b></div>
                    <img src="https://ms-solutions-edu-web-java.s3.us-east-1.amazonaws.com/home/va.jpg" alt="Vanisa" style="width:100%">
                </div>
            </div>
            <div class="w3-col l3 m6 w3-margin-bottom">
                <div class="w3-display-container">
                    <div class="w3-display-bottomleft w3-padding" style="background-color: rgba(0, 0, 0, 0.5); color: white;"><b>Engineer Giles</b></div>
                    <img src="https://ms-solutions-edu-web-java.s3.us-east-1.amazonaws.com/home/giles1.jpg" alt="Giles" style="width:100%">
                </div>
            </div>
        </div>
        ...
        <div class="w3-row-padding">
            <div class="w3-col l3 m6 w3-margin-bottom">
                <div class="w3-display-container">
                    ...
                    <img src="https://ms-solutions-edu-web-java.s3.us-east-1.amazonaws.com/home/flora-home.jpg" alt="Flora" style="width:99%">
                </div>
            </div>
            <div class="w3-col l3 m6 w3-margin-bottom">
                <div class="w3-display-container">
                    <div class="w3-display-bottomleft w3-padding" style="background-color: rgba(0, 0, 0, 0.5); color: white;"><b>Engineer Max</b></div>
                    <img src="https://ms-solutions-edu-web-java.s3.us-east-1.amazonaws.com/home/max1.jpg" alt="Max" style="width:99%">
                </div>
            </div>
            <div class="w3-col l3 m6 w3-margin-bottom">
                <div class="w3-display-container">
                    <div class="w3-display-bottomleft w3-padding" style="background-color: rgba(0, 0, 0, 0.5); color: white;"><b>Engineer Emma</b></div>
                    <img src="https://ms-solutions-edu-web-java.s3.us-east-1.amazonaws.com/home/emma-home.jpg" alt="Emma" style="width:99%">
                </div>
            </div>
            <div class="w3-col l3 m6 w3-margin-bottom">
                <div class="w3-display-container">
                    <div class="w3-display-bottomleft w3-padding" style="background-color: rgba(0, 0, 0, 0.5); color: white;"><b>Engineer Vicky</b></div>
                    <img src="https://ms-solutions-edu-web-java.s3.us-east-1.amazonaws.com/home/vicky-home.jpg" alt="Vicky" style="width:99%">
                </div>
            </div>
        </div>
        ...
        <div class="w3-row-padding w3-grayscale">
            ...
            <div class="w3-col l3 m6 w3-margin-bottom">
                <img src="https://ms-solutions-edu-web-java.s3.us-east-1.amazonaws.com/about/innovation.jpg" alt="innovation" style="width:100%">
            ...
            <div class="w3-col l3 m6 w3-margin-bottom">
                <img src="https://ms-solutions-edu-web-java.s3.us-east-1.amazonaws.com/about/success.jpg" alt="Mike" style="width:100%">
            ...
            <div class="w3-col l3 m6 w3-margin-bottom">
                <img src="https://ms-solutions-edu-web-java.s3.us-east-1.amazonaws.com/about/customer-service.jpg" alt="Dan" style="width:100%">
        ...
        <div class="w3-row-padding w3-col">
            ...
            <div class="w3-col l3 m6 w3-margin-bottom">
                <img src="https://ms-solutions-edu-web-java.s3.us-east-1.amazonaws.com/teams/vicky-team.jpg" alt="Vicky" style="width:100%">
                <h3>V. Victorine</h3>
                <p class="w3-opacity">Sr. Software Engineer</p>
        ...
        <div class="w3-container">
            <img src="https://ms-solutions-edu-web-java.s3.us-east-1.amazonaws.com/header-footer/footer1.jpg" class="w3-image" style="width:100%">
        </div>
    ...
    <footer class="w3-center w3-black w3-padding-16">
        <p class="w3-small">© Copyright techpulse 2002 - 2024. Designed by MS-Solutions Inc.</p>
